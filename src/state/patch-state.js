...
export function normalizePatch(patch = {}) {
  return {
    ...
    mode: ["pad", "arp"].includes(patch.mode) ? patch.mode : DEFAULT_PATCH.mode,
...
function normalizeCore(core = {}) {
  return {
    ...
    scaleName: ["none", "major", "minor", "dorian", "mixolydian", "phrygian", "harmonicMinor"].includes(core.scaleName) ? core.scaleName : DEFAULT_PATCH.core.scaleName,
