export function getElements(root = document) {
  return {
    ...
    harmonicDistanceTarget: root.querySelector("#harmonicDistanceTarget"),
    harmonicDistanceFalloff: root.querySelector("#harmonicDistanceFalloff"),
...
export function readCoreSettings(els, mode, generatorMode = "classic") {
  return {
    ...
    harmonicDistanceTarget: Number(els.harmonicDistanceTarget?.value ?? 1),
    harmonicDistanceFalloff: Number(els.harmonicDistanceFalloff?.value ?? 1),
